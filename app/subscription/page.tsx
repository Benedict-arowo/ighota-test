  ...
  return (
    <div className="container py-10">
      <div className="mx-auto max-w-[58rem] text-center">
        <h1 className="text-3xl font-bold sm:text-4xl">Subscription Plans</h1>
        <p className="mt-2 text-muted-foreground">
          Choose the right plan for your educational journey. Upgrade or downgrade at any time.
        </p>
              ...
              <div className="grid gap-3 text-sm">
                {plan.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    />
                    <span
                      className={cn("text-sm", !feature.included && "text-muted-foreground line-through opacity-75")}
                    >
                      {feature.text}
                    </span>
                  </div>
